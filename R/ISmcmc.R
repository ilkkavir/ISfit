ISmcmc <- function( measData , measVar , initParam , aprioriTheory , aprioriMeas , invAprioriCovar , paramLimits , directTheory , MCMCsettings=list() , ... )
    {
        ...
        mcmcargs <- c( list( f=SS , p=init2 , measData=measData , measVar=measVar , directTheory=directTheory , aprioriTheory=aprioriTheory , aprioriMeas=aprioriMeas , invAprioriCovar=invAprioriCovar , lower=paramLimits[1,] , upper=paramLimits[2,] , jump=initres$covar ) , MCMCsettings , list( ... ))
        ...
        return(c(initres,MCMC=c(resmcmc,res)))
