ISparamScales.default <- function(param,nIon){
#
#
#
#
...
#
  ...
  # set ion velocity steps to 1
  parScales[seq(5,length(parScales),by=8)] <- 1
  parScales[seq(6,length(parScales),by=8)] <- 1
  parScales[seq(7,length(parScales),by=8)] <- 1
