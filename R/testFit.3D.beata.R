...
#    dev.new()
    ...
    # range ambiguity for full and fractional lags are different, compensate for this by scaling the full lags
    fullinds <- c(lagT,lagK,lagS)%%20 == 0
    acf[fullinds] <- acf[fullinds] / (5/3)
    var[fullinds]  <- var[fullinds] / (5/3)**2
